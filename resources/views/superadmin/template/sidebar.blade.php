<ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #cccccc">
    ...
    <!-- Nav Item - Profile -->
    <li class="nav-item">
        <a class="nav-link collapsed" href="/profile-super-admin" style="color: black">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="/data-dosen" style="color: black">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="/download-all" style="color: black">
