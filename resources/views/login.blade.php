...
<body>
    <nav class="navbar" style="background-color: #ff9933;color: white">
        <div class="container justify-content-between">
            ...
            <h5 class="font-weight-bold" style="font-family: Arial, Helvetica, sans-serif">Sistem Informasi Portofolio
                Dosen</h5>
        ...
        <div class="col">
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="mt-5">
                            <h1 style="color: black">Selamat Datang Di Sistem Informasi Portofolio Dosen Politeknik
                                Kampar</h1>
                        </div>
                        <div class="mt-5">
