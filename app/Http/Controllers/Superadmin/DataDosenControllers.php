...
class DataDosenControllers extends Controller
{
    ...
    function check($id)
    {
        ...
        $patendanhaki = PatenHakiModels::select('tb_patendanhaki.*')
            ->where('id', $id)
            ->get();
        return view('superadmin.datadosen.checkdata', compact('biodata', 'pendidikan', 'jabatan', 'kompetensi', 'mengajar', 'seminardanpelatihan', 'penelitian', 'publikasi', 'pengabdian', 'hibah', 'buku', 'patendanhaki','id'));
    }
    ...
    function checkCV($id)
    {
        ...
        $patendanhaki = PatenHakiModels::select('tb_patendanhaki.*')
            ->where('id', $id)
            ->get();
        return view('superadmin.datadosen.checkdataCV', compact('biodata', 'pendidikan', 'jabatan', 'kompetensi', 'mengajar', 'seminardanpelatihan', 'penelitian', 'publikasi', 'pengabdian', 'hibah', 'buku', 'patendanhaki','id'));
    }
